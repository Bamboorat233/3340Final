...
<html lang="en">
  <head>
    ...
    <!-- Page-specific logic and cart handling -->
    <script defer src="js/inear.js"></script>
    <script defer src="js/cart.js"></script>
    <script defer src="js/main.js"></script>
  </head>
  <body>
    <!-- Include sidebar and top navigation -->
    <?php include 'siderTopBar.php'; ?>

    <!-- Main slider section for displaying audio cables -->
    <main>
      <div class="slider">
        ...
        <div class="slide active">
          <div class="floating-box">
            ...
            <img src="images/MOONDROP Silver pill_2.png" alt="MOONDROP Silver pill 2nd angle" />
        ...
        <div class="slide">
          <div class="floating-box">
            ...
            <p>
              Litz-Structure Single Crystal Copper + Special Silver Solder High-Quality Braided Upgrade Cable
            </p>
            <img src="images/Moondrop Atami.png" alt="Moondrop Atami" />
            <img src="images/Moondrop Atami_2.png" alt="Moondrop Atami 2nd angle" />
        ...
        <!-- Slide: TWISTURA CHENXI -->
        <div class="slide">
          <div class="floating-box">
            <h2>TWISTURA CHENXI</h2>
            <p>Headphone Upgrade Cable</p>
            <img src="images/TWISTURA CHENXI.png" alt="TWISTURA CHENXI" />
            <img src="images/TWISTURA CHENXI_2.png" alt="TWISTURA CHENXI 2nd angle" />
        ...
        <!-- Slide: Tripowin Aurora -->
        <div class="slide active">
          <div class="floating-box">
            <h2>Tripowin Aurora</h2>
            <p>HiFi Replacement Cable for Wired Earbuds</p>
            <img src="images/Tripowin Aurora.png" alt="Tripowin Aurora" />
            <img src="images/Tripowin Aurora_2.png" alt="Tripowin Aurora 2nd angle" />
        ...
        <!-- Slide: Kiwi Ears Terras -->
        <div class="slide active">
          <div class="floating-box">
            <h2>Kiwi Ears Terras</h2>
            <p>4N OCC Audiophile Cable</p>
            <img src="images/Kiwi Ears Terras.png" alt="Kiwi Ears Terras" />
            <img src="images/Kiwi Ears Terras_2.png" alt="Kiwi Ears Terras 2nd angle" />
